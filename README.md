...
{{$laravelDashPackageName->sns()}}
{{$laravelDashPackageName->s3()}}
{{$laravelDashPackageName->billing()}}
{{$laravelDashPackageName->ima()}}
{{$laravelDashPackageName->widget()}}
{{$laravelDashPackageName->lightsail()}}
{{$laravelDashPackageName->services()}}
